...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        if date == None:
            ...
            yesterday_date = str(datetime.date.today() - datetime.timedelta(days=712)).replace('-', '')

            batchs = requests.get('http://virt43/svod-pol/hs/NewProgram/GeProductiontList/'+yesterday_date+'/'+date,
