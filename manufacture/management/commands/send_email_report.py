...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        if address:
            ...
            message = EmailMessage('Отчёт по работе завода', 'Отчёт во вложении', settings.EMAIL_HOST_USER, ['arkhipov.aal@nn.mag-rf.ru', 'belov.kk@mag-rf.ru', 'novosadov.dv@nn.mag-rf.ru'])
