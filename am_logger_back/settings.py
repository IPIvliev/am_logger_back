"""
Django settings for am_logger_back project.
...
SECRET_KEY = 'django-insecure-z#p7=7p3txt$@$nc_5pk8#z9n#d35glr19*9rbpye$wx+*4hnn'
...
CSRF_TRUSTED_ORIGINS = ['http://*.mag-rf.ru', 'https://*.mag-rf.ru']
...
WSGI_APPLICATION = 'am_logger_back.wsgi.application'
